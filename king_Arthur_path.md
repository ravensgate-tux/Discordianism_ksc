...
自ら「記憶の神殿」を構築し、その中で象徴を配置していく作業である。  
そのため準備作業に大きな労力を要し、同時に記憶力と感覚を鍛える訓練にもなる。  

### 手順

1. ドゥーン城を写真や図面を見ながら完全に心の中に構築する。  
2. 構築したドゥーン城を自由に歩き回れるまで視覚化を行う。  
3. ビアズリーの絵を掛ける位置を探す。  
   - **小径の番号による属性**（例：ケテル⇄ティファレトなら中心的役割）  
   - **絵から感じるストーリー**（例：入り口＝マルクト、内部＝イェソド → そこに「世界」の絵を掛けるのは理にかなう）  
   - **空間の定義**（例：グレートホールをティファレトに対応させる）  
   これらを参考に、感覚と理論の両面から配置を決定する。  
4. 一つずつ掛け終わったら終了とする。  
5. 城の中を歩き回り、**すべての絵が正しい位置に存在しているかを確認する**。  

この方法は「象徴を体験する」のではなく、  
**「象徴を配置し、舞台そのものを育てていく」ことがパスワーキングの核心** となる。  
