...
- **位置づけ**：「積極的な視覚化訓練」であり、心霊的な能力開発ではない（『魔法修行』より）
...
- **方法**
  1. 鏡をじっと見つめる（自分の顔が曖昧になるまで）
  2. 線がぼやけて自分が誰かわからなくなるまで観察を続ける
  3. 目を閉じ、視覚化された光（Ｘの形）を保持する
- **目的**：「自己意識を変容させる実践」として機能し、黒い煙のようになって、忘却、無作為、無意識に消えるイメージを構築できる
...
- **コンセプト**：凹面の前に小物（像・シンボル等）を置き、ミラーに写る**二重像**を両眼視（交差法/平行法）で**空中合成**し、「存在するはずのない像」を安定保持する（この写真の例では、奥のブラックミラーに映る金のバステトはが凹面鏡の効果で二重像が作られ、それを立体視で合成すると空中に浮いて見える）
...
- **手順**
  ...
  4. 合成像が安定したら、**呼吸を浅く静かに**し、その像を映像として保つ
...
- **安定のコツ**
  ...
  - （参照）交差法・平行法は、一般に『マジカル・アイ』など立体視トレーニングで知られている
...
👉 W.E.バトラーの『魔法修行』で紹介されているように、時計皿を使えば、**黒曜石の鏡が数万円するのに対し、時計皿＋塗料＋皿立てで合計2,000円程度**で作成ができる  
👉 **バトラー流＝能動訓練**、**スペア流＝無作為**、**立体視法＝知覚のゲート操作**として使い分け・併用することができる
