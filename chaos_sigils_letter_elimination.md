# 英語圏のケイオスマジックにおける「重複文字を消す」ルールは一般的か？
...
👉
母音を消すのはキャロルやハイン由来ではなく、**モリソン以降の新ルール**。
...
-   **日本の現状：**<br>
   フラターＵ∴Ｄ∴のPractical Sigil Magicが『**オースティン・スペアの魔術**』と意訳されたためスペアが重複文字を削除したという**誤った情報**が広まった
...
つまり**重複文字を削除せず、スペアのシジル制作法に戻る価値が大いにある**と考えられる。  
